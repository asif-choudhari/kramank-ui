  ...
  return (
    <>
      ...
      <div className="mt-24 mb-20 flex items-center justify-center relative">
        <div className="w-11/12 h-[400px] md:h-[525px] px-1 bg-[url('/public/homeBG.png')] rounded-3xl shadow-2xl flex justify-center items-center text-white text-3xl text-center font-bold">
